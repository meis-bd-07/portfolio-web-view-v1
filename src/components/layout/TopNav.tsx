    ...
    <header className="fixed top-0 left-0 right-0 z-50 h-nav border-b border-border bg-background/80 backdrop-blur-sm">
      <div className="flex h-full items-center justify-between px-3 sm:px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <a href="/" className="flex items-center gap-2">
            <div className="flex items-center gap-1">
              ...
              <span className="text-base sm:text-lg font-semibold text-foreground">NEXT.JS</span>
            </div>
          </a>

          <nav className="hidden lg:flex items-center gap-4 xl:gap-6 ml-4 xl:ml-6">
            <a href="#" className="nav-link">Showcase</a>
            <a href="#" className="nav-link nav-link-active">Docs</a>
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <Button size="sm" className="bg-foreground text-background hover:bg-foreground/90 text-xs sm:text-sm">
            Learn
          </Button>
        </div>
      </div>
